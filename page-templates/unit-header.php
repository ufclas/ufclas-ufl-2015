  ...
  <div class="landing-page-hero">
  	<div class="container">
        ...
        <div class="col-sm-7 col-sm-pull-1">
          <div class="img-hero" style="background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/img/_temp-landing-a-1.jpg)"></div>
        </div>
        ...
        <div class="col-sm-7 secondary">
          <div class="img-hero" style="background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/img/_temp-landing-a-2.jpg)"></div>
        </div>
  		</div>
  	</div>
  </div>
	  	...
	  	<div class="row">
	  		<div class="col-md-6">
	  			<div class="gal-with-caption">
		  			<div class="gal-img temp-img">
		  				<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/_temp-landing-a-1.jpg" alt="" class="visuallyhidden">
	  				</div>
	  				<div class="caption">Lorem ised ut perspiciatis unde omnis iste natus error sit voluptatem accus antium doloremque</div>
	  			</div>
	  		</div>
	  		<div class="col-md-6">
	  			<h2>Secondary Headline here</h2>
	  			...
	  			<ul class="big-list">
	  				<li class="btn-mobile-toggle" aria-hidden="true" role="presentation"><a href="#">Additional Links <span class="arw-right icon-svg"><svg><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/img/spritemap.svg#arw-right"></use></svg></span></a></li>
	  				<li><a href="#">A list item here <span class="arw-right icon-svg"><svg><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/img/spritemap.svg#arw-right"></use></svg></span></a></li>
	  				<li><a href="#">A list item here <span class="arw-right icon-svg"><svg><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/img/spritemap.svg#arw-right"></use></svg></span></a></li>
	  				<li><a href="#">A list item here <span class="arw-right icon-svg"><svg><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/img/spritemap.svg#arw-right"></use></svg></span></a></li>
	  				<li><a href="#">A list item here <span class="arw-right icon-svg"><svg><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/img/spritemap.svg#arw-right"></use></svg></span></a></li>
	  				<li><a href="#">A list item here <span class="arw-right icon-svg"><svg><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/img/spritemap.svg#arw-right"></use></svg></span></a></li>
